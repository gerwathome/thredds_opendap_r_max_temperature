...
## Prerequisites:
R v3.3 or later. R packages: `ncdf4`

## Procedure

### 1. Load R packages: ncdf4
...
***This step may take several minutes because of big volume of data***
```{r}
...
In this step, we will show how to access the actual value of mexmimum temperature variable in both datasets. The indices from last step are used to retrieve maximum temperature at the point of interest for entire year.
